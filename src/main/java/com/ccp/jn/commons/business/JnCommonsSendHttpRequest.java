...
public class JnCommonsSendHttpRequest {

	public static final JnCommonsSendHttpRequest INSTANCE = new JnCommonsSendHttpRequest();
	private JnCommonsSendHttpRequest() {}
	public CcpJsonRepresentation execute(CcpJsonRepresentation json, Function<CcpJsonRepresentation, CcpJsonRepresentation> processThatSendsHttpRequest, JnCommonsHttpRequestType httpRequestType, String...keys) {
	...
	private CcpJsonRepresentation retryToSendIntantMessage(CcpHttpError e, CcpJsonRepresentation json, CcpJsonRepresentation httpErrorDetails, Function<CcpJsonRepresentation, CcpJsonRepresentation> processThatSendsHttpRequest, JnCommonsHttpRequestType httpRequestType, String... keys) {
