...
public class JnCommonsSendInstantMessage {

	
	public static final JnCommonsSendInstantMessage INSTANCE = new JnCommonsSendInstantMessage();
	
	private JnCommonsSendInstantMessage() {
