...
public class JnJsonTransformerPutFormattedCurrentDateAndCurrentTimeStamp implements Function<CcpJsonRepresentation, CcpJsonRepresentation> {
	...
	public static final JnJsonTransformerPutFormattedCurrentDateAndCurrentTimeStamp INSTANCE = new JnJsonTransformerPutFormattedCurrentDateAndCurrentTimeStamp();
