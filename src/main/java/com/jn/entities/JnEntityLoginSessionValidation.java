...
@CcpEntitySpecifications(
	    ...
	    save = @CcpEntityOperationSpecification(afterOperation = {}, beforeOperation = {JnJsonTransformerPutEmailHash.class, JnJsonTransformerPutRandomTokenHash.class}, classWithFieldsValidationsRules = CcpIgnoreFieldsValidation.class),
