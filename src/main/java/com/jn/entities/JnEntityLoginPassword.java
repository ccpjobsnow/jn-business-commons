...
import com.jn.json.transformers.JnJsonTransformerPutPasswordSecret;
...
@CcpEntitySpecifications(
	    ...
	    save = @CcpEntityOperationSpecification(afterOperation = {}, beforeOperation = {JnJsonTransformerPutEmailHash.class
	    		, JnJsonTransformerPutPasswordSecret.class}, classWithFieldsValidationsRules = CcpIgnoreFieldsValidation.class),
