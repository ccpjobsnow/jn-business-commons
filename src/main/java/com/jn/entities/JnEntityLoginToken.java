...
import com.jn.json.transformers.JnJsonTransformerPutRandomTokenSecret;
...
@CcpEntitySpecifications(
	    ...
	    save = @CcpEntityOperationSpecification(afterOperation = {}, beforeOperation = {JnJsonTransformerPutEmailHash.class, JnJsonTransformerPutRandomTokenSecret.class}, classWithFieldsValidationsRules = CcpIgnoreFieldsValidation.class),
