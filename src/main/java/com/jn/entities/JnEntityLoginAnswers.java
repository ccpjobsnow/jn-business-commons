...
@CcpEntitySpecifications(
	    ...
	    save = @CcpEntityOperationSpecification(afterOperation = {}, beforeOperation = {JnJsonTransformerPutEmailHash.class}, classWithFieldsValidationsRules = JnJsonFieldsValidationLoginAnswers.class),
