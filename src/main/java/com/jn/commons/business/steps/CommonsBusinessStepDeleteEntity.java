...
public class CommonsBusinessStepDeleteEntity extends CcpNextStep {
	...
	public CommonsBusinessStepDeleteEntity(CcpEntity entity, CcpProcessStatus statusToReturnAfterSaving) {
