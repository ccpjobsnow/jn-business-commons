...
@CcpEntitySpecifications(
	    ...
	    save = @CcpEntityValidation(afterOperation = {}, beforeOperation = {JnJsonTransformerPutEmailHash.class, JnJsonTransformerPutRandomTokenHash.class}, jsonValidationClass = CcpNoValidation.class),
