...
@CcpEntitySpecifications(
	    ...
	    save = @CcpEntityValidation(afterOperation = {}, beforeOperation = {JnJsonTransformerPutEmailHash.class
	    		, JnJsonTransformerPutPasswordSecret.class}, jsonValidationClass = CcpNoValidation.class),
