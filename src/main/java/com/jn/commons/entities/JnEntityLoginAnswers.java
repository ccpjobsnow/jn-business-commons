...
@CcpEntitySpecifications(
	    ...
	    save = @CcpEntityOperationSpecification(afterOperation = {}, beforeOperation = {JnJsonTransformerPutEmailHash.class}, classWithFieldsValidationsRules = JnJsonValidationLoginAnswers.class),
